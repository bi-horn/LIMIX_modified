...
def fetch(target, fetch_spec, verbose=True):
    from limix_modified._data._asarray import asarray
    from limix_modified._data._assert import assert_target, assert_filetype
...
def _fetch_bed_genotype(filepath, verbose=True):
    ...
    from limix_modified._data import asarray
