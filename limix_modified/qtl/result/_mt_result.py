...
class MTScanResult:
    ...
    #I replaced this property by the property below because this one compute degrees of freedom as number of effect size parameters (.size), not rank of design matrix
    #-> this causes deflated results for the interaction test
    @property
