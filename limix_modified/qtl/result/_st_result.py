from limix_modified._cache import cache
from limix_modified.stats._lrt import lrt_pvalues
...
class STScanResult:
    ...
    def _covariance_expr(self):
        ...
        v0 = self.h0.variances["fore_covariance"].iloc[0]
        v1 = self.h0.variances["back_covariance"].iloc[0]
...
'''Because of warning; modified version above ("FutureWarning: Calling float on a single element Series is deprecated and will raise a TypeError in the future. Use float(ser.iloc[0]) instead
