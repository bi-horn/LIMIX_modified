...
https://github.com/limix/glimix-core/blob/master/glimix_core/cov/_kron2sum.py
Only changed code to import a refactored lrfreeform covariance class which supports QR-based initialization
'''
...
from glimix_core._util import cached_property, format_function, unvec
from glimix_core.cov._free import FreeFormCov
#from glimix_core.cov._lrfree import LRFreeFormCov      # replaced by refactored  LRFreeFormCov
...
class Kron2SumCov(Function):
    ...
    def __init__(self, G, dim, rank, original_L_init):
        """
        Constructor.
        ...
        self._C0 = LRFreeFormCov(dim, rank, original_L_init)
        self._C0.name = "C₀"
