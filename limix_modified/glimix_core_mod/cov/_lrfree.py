...
Changed lrfreeform covariance initialization and therefore added argument "original_L_init"
'''

from numpy import asarray, dot, ones, zeros
import numpy as np
from optimix import Function, Vector
from glimix_core._util import format_function

class LRFreeFormCov(Function):
    """
    General semi-definite positive matrix of low rank, K = L Lᵀ.
    """

    def __init__(self, n, m, original_L_init):
        """
        Constructor.
