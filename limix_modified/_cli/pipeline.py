#Dieser Code definiert eine Pipeline-Klasse, die dazu dient, eine Abfolge von Datenverarbeitungsschritten auf einem Datensatz auszuführen
...
class Pipeline(object):
    ...
    def run(self, verbose=True):
        from _data._conform import conform_dataset
