...
from limix_modified._bits.deco import return_none_if_none
from limix_modified._bits.xarray import set_coord
...
#The provided code defines a function, conform_dataset, which converts various types of data (like outcomes, covariates, genotypes, and kinship matrices) into xarray.DataArray objects.
...
def _fix_samples(data, sample_dims):
    from limix_modified._bits.xarray import take
...
def _match_samples(data, dims):
    #from pandas.core.index import InvalidIndexError #old
